        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                    ...
                                    <form class="d-flex align-items-center"
                                        method="GET" action="{{ route('cari.kab') }}"
                                        ...
                                        @if(request('search'))
                                            <a href="{{ route('kab.index') }}" style="background: none; border: none; text-decoration: none;">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#tambahKabModal">
                                                Tambah Manual
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#importKabModal">
                                                Import Excel
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div class="modal fade" id="tambahKabModal" tabindex="-1" aria-labelledby="tambahKabModalLabel" aria-hidden="true">
                 ...
                 {{-- modal import excel --}}
                <div class="modal fade" id="importKabModal" tabindex="-1" aria-labelledby="importKabModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="importKabModalLabel">Import Data Provinsi dari Excel</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>

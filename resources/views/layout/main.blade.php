...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('template/dist/assets/vendors/datatables.net-bs5/dataTables.bootstrap5.css')}}">
    <link rel="stylesheet" href="{{ asset('template/dist/assets/vendors/ti-icons/css/themify-icons.css')}}">
  ...
  <ul class="nav">
    ...
    <script src="{{ asset('template/dist/assets/vendors/datatables.net-bs5/dataTables.bootstrap5.js')}}"></script>
    <script src="{{ asset('template/dist/assets/js/dataTables.select.min.js')}}"></script>

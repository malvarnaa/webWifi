...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    ...
    <!-- Tombol Login & Register dengan Jarak Lebih Baik -->
    <div class="d-flex gap-2 ms-auto">
        <a class="btn btn-outline-primary rounded-pill px-4" href="{{ url('/login')}}">Login</a>
        <a class="btn btn-primary rounded-pill px-4" href="{{ url('/register')}}">Register</a>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center" data-aos="zoom-out">
          <div class="col-xl-7 col-lg-9 text-center">
            <h1>Internet Kencang, Hidup Makin Lancar!</h1>
            <p>Kami hadir memberikan layanan terbaik untuk anda!</p>
          </div>
        </div>
        <div class="text-center" data-aos="zoom-out" data-aos-delay="100">
          <a href="#about" class="btn-get-started">Langganan Sekarang</a>
        </div>

        <div class="row gy-4 mt-5 d-flex flex-wrap justify-content-center">
          @foreach ($paket as $item)
              <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="100">
                  <div class="card shadow-lg border-0 rounded-4 p-4">
                      <div class="card-body text-center">
                          <h6 class="text-primary fw-bold">{{ $item->nama_paket }}</h6>
                          <h4 class="fw-bold text-success">{{ $item->kecepatan }}</h4>
                          <h3 class="fw-bold text-dark">Rp{{ number_format($item->harga, 0, ',', '.') }} <small class="text-muted">/ Bulan</small></h3>
                         
                          <a href="{{url('/register')}}" class="btn btn-primary w-100 fw-bold rounded-pill py-2">Langganan Sekarang</a>
      
                          <hr>
      
                          <div class="text-start">
                              <h6 class="fw-bold mb-3 text-dark">Fitur dan Benefit</h6>
                              <ul class="list-unstyled">
                                  <li class="d-flex align-items-center mb-2"><i class="bi bi-wifi text-primary me-2"></i> Internet UNLIMITED</li>
                                  <li class="d-flex align-items-center mb-2"><i class="bi bi-router text-primary me-2"></i> Include ONT/Modem</li>
                                  <li class="d-flex align-items-center mb-2"><i class="bi bi-gift text-primary me-2"></i> Gratis Instalasi Rp500.000</li>
                                  <li class="d-flex align-items-center mb-2"><i class="bi bi-pc-display text-primary me-2"></i> Ideal untuk 1 - 3 Device</li>
                                  <li class="d-flex align-items-center"><i class="bi bi-arrow-left-right text-primary me-2"></i> DL & UL 1:1 up to {{ $item->kecepatan }}</li>
                              </ul>
                          </div>
                      </div>
                  </div>

          ...
          @foreach ($paket as $item)
              <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="100">
                  <div class="icon-box">
                      ...
                      <h4 class="title"><a href="">{{ $item->nama_paket }}</a></h4>
                      <p class="description">
                          Kecepatan: {{ $item->kecepatan }}<br>
                          {{ $item->deskripsi }}<br>
                          Harga: Rp{{ number_format($item->harga, 0, ',', '.') }}
                      </p>
                      <div class="langganan-btn">
                        <a href="#" type="button" class="btn btn-primary mt-3 rounded-pill">Langganan</a>
                      </div>
                  </div>
              </div><!-- End Icon Box -->
          @endforeach
